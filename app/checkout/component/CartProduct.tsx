...
function CartProduct({ cartItem, addToCart }: { cartItem: CartItem, addToCart: any }) {
            ...
            <div className="relative flex h-24 items-center justify-between gap-2 text-sm md:h-40 xl:h-48 ">
                ...
                <div className="flex flex-col items-end justify-around gap-4 xl:flex-row xl:items-center">
                    <div className="flex flex-row ">
                        <div className="border-1 border-r-0 border-neutral-800 border-opacity-50 p-3  md:p-3 md:px-6 rounded-l-md" >1</div>

                        <div className="border-1 border-r-0 border-neutral-800 border-opacity-50 p-3  md:p-3 hover:bg-neutral-200 transition-all ease-in cursor-pointer select-none"
                            onClick={() => addToCart({ ...cartItem, quantity: 1 })}
                        >+</div>

                        <div className="border-1 rounded-r-md border-neutral-800 border-opacity-50 p-3  md:p-3 hover:bg-neutral-200 transition-all ease-in cursor-pointer select-none"
                            onClick={() => addToCart({ ...cartItem, quantity: - 1 })}
                        >-</div>
                    </div>
                    <Button
